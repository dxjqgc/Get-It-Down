...
const messages: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "success.importedAppend": "追加导入成功，共新增 {count} 条任务",
    ...
    "hero.importAppendConfirmTitle": "确认追加导入？",
    "hero.importAppendConfirmDescription": "追加导入会保留现有任务，并把文件中的任务作为新任务追加进来。",
    "hero.importModeReplace": "覆盖导入",
    "hero.importModeAppend": "追加导入",
    "language.label": "语言",
    "language.zhCN": "简体中文",
    ...
    "quick.markDone": "标记完成",
    "quick.markImportant": "标记重点",
    "quick.unmarkImportant": "取消重点",
  ...
  "en-US": {
    ...
    "success.importedAppend": "Append import succeeded with {count} new tasks",
    ...
    "form.status": "Status",
    "form.isImportant": "Important task",
    ...
    "hero.importAppendConfirmTitle": "Append import to current data?",
    "hero.importAppendConfirmDescription": "Append import will keep current tasks and add imported tasks as new ones.",
    "hero.importModeReplace": "Overwrite import",
    "hero.importModeAppend": "Append import",
    ...
    "quick.markImportant": "Mark important",
    "quick.unmarkImportant": "Unmark important",
