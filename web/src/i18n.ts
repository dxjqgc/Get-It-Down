...
const messages: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "form.inheritable": "可继承",
    "form.nonInheritable": "不可继承",
    "form.crossLevelInheritable": "可跨级",
    "form.nonCrossLevelInheritable": "不可跨级",
    "form.inheritedPropertySelection": "继承父级属性",
    "form.inheritedPropertySelectionPlaceholder": "选择需要继承的属性",
    "common.delete": "删除",
  ...
  "en-US": {
    ...
    "form.inheritable": "Inheritable",
    "form.nonInheritable": "Not inheritable",
    "form.crossLevelInheritable": "Cross-level",
    "form.nonCrossLevelInheritable": "Single-level",
    "form.inheritedPropertySelection": "Inherited parent properties",
    "form.inheritedPropertySelectionPlaceholder": "Select properties to inherit",
